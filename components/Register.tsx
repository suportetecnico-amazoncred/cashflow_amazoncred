...
interface OperationsProps {
  onCompleteTransaction: (clientId: string, type: MovementType, amount: number, description: string, installments?: number) => void;
  clients: Client[];
}

const Register: React.FC<OperationsProps> = ({ onCompleteTransaction, clients }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Bloqueia saque se o saldo for insuficiente
    ...
    // Bloqueia pagamento de parcela se o saldo for insuficiente (Impede saldo negativo)
    ...
    // Validação para não pagar mais do que deve
